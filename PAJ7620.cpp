...
uint8_t PAJ7620Init(void) 
{
	...
	PAJ7620WriteReg(PAJ7620_ADDR_BASE, PAJ7620_BANK0);
	PAJ7620WriteReg(PAJ7620_ADDR_BASE, PAJ7620_BANK0);
	...
	for (i = 0; i < sizeof(initRegisterArray)/sizeof(initRegisterArray[0]); i++) 
	{
		PAJ7620WriteReg(initRegisterArray[i][0], initRegisterArray[i][1]);
	}
	
	PAJ7620WriteReg(PAJ7620_ADDR_BASE, PAJ7620_BANK0);  //gesture flage reg in Bank0
